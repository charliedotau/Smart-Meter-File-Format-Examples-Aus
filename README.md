...
## The problem
The problem is there is no common format in which the electricity companies supply this data. Across the nation there are likely dozens of different formats.
...
The goal of this repo is to collate as many examples as possible of the different file formats used by Australian electricity utilities and distributors for exporting smart meter data.  Nothing more, nothing less.
